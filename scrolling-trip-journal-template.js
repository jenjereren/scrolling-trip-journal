$(function () {
  console.log(
    "%c⚛ Map Effects 100: Hello geohacker! ⚛",
    "font-family:monospace;font-size:16px;color:darkblue;"
  );
  ...
  function initMap() {
    ...
    $.getJSON("data/norte_trip.geojson", function (data) {
        ...
        onEachFeature: function (feature, layer) {
          (function (lyr, properties) {
            ...
            var svgIcon = L.divIcon({
              className: "svg-icon",
              html:
                '<svg class="mizube-svg" width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path id="mizube' +
                properties.NO_ +
                '" fill="none" stroke="' +
                iconColor +
                '" stroke-opacity="0.75" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" d="' +
                svgPath +
                '"></path></svg>',
            });
            ...
            var title = $("<h3></h3>", {
              text: feature.properties.NO_ + ". " + feature.properties["title"],
              class: "photo-text",
            });
            var photo = $("<img>", {
              src: "data/img/" + feature.properties["photo"],
              width: "100%",
            });
            var description = $("<p></p>", {
            ...
            // Watch the current scroll position for scroll-driven map navigation!
            if (feature.properties.OBJECTID === 1) {
            ...
            $("div#photos").scroll(function () {
              if (
                ...
                $("div#container" + feature.properties.OBJECTID).css(
                  "opacity",
                  1
                );
                map.setView(
                  [
                    ...
                    feature.geometry.coordinates[0] + 0.015,
                  ],
                  13
                );
