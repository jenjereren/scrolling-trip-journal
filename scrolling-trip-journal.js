...
function () {
  ...
  function initMap() {
    ...
    $.getJSON('/north_trip/data/norte_trip.geojson', function (data) {
      var geojson = L.geoJson(data, {
        onEachFeature: function (feature, layer) {
          (function (lyr, properties) {
            ...
            var photo = $('<img>', {
              src: '/north_trip/data/img/' + feature.properties['photo'],
              width: '100%'
            });
            var description = $('<p></p>', {
            ...
            $('div#photos').scroll(function () {
              if ($(this).scrollTop() >= areaTop && $(this).scrollTop() < areaBottom) {
                ...
                map.setView([feature.geometry.coordinates[1], feature.geometry.coordinates[0] + 0.015], 13);
